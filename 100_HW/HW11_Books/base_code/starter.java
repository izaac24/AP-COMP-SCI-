...
class starter {
		...
		*/
		while(true){
			...
			if(choice.equals("file")){
				...
				checksArray(arr,y);
				System.out.println("The word " + y + " was found " + checksArray(arr,y) + " times.");
	...
	*/
	public static void printsNumber(String[] arr, int a){
		if (a > arr.length) {
	...
	*/
	public static int checksArray(String[] arr, String check){
		int num = 0;
		for(int spud = 0; spud < arr.length; spud++){
			if(check.equals(arr[spud])){
				num = num + 1;
			}
		}
		return num;
